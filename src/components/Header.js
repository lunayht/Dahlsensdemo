...
import { AppBar, withStyles, Button, Toolbar } from '@material-ui/core';
            ...
            <div className={classes.flexGrow}>
                <AppBar className={classes.appbar} color="inherit" position="static">
                    <Toolbar>
                        ...
                        <Button className={classes.headerbtn} onClick={this.handleMonitor} color='inherit'>Monitoring</Button>
